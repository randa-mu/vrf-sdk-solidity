# Make sure this script is executable. On Unix based systems, run "chmod +x generate-contract-addresses.sh".
# To run this script, type "./generate-contract-addresses.sh".
